...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lightmarey', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '才疏学浅的学术混子', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lightmarey.vercel.app/', // 网站地址
